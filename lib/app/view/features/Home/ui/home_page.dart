...
class _HomePageState extends State<HomePage> {
  final Localstorage pref = getIt<Localstorage>();
  ...
  void initState() {
    ...
    fetchUserDetails(); // ✅ IMPORTANT
  }

  Future<void> fetchUserDetails() async {
    final u = await pref.getValue<String>('username');
    final img = await pref.getValue<String>('image');
    final em = await pref.getValue<String>('email');
    final fn = await pref.getValue<String>('firstName');
    final ln = await pref.getValue<String>('lastName');
    final g = await pref.getValue<String>('gender');
        ...
        actions: [
          Row(
            ...
            children: [
              ...
              OutlinedButton(onPressed: () {}, child: Icon(Icons.logout)),
              SizedBox(),
            ],
          ),
        ],
